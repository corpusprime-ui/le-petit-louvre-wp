...
acf_add_local_field_group( [
    ...
    'fields'     => [
        ...
        [
            'key'          => 'field_lpl_photos',
            'label'        => 'Photos du diaporama',
            'name'         => 'lpl_photos',
            'type'         => 'repeater',
            'instructions' => 'Ajoutez 2 à 4 photos. Elles s\'afficheront en fondu enchaîné l\'une après l\'autre. La première photo est chargée en priorité.',
            'min'          => 1,
            'max'          => 4,
            'layout'       => 'table',
            'button_label' => 'Ajouter une photo',
            'sub_fields'   => [
                ...
                [
                    'key'          => 'field_lpl_photos_alt',
                    'label'        => 'Description (SEO / accessibilité)',
                    'name'         => 'alt',
                    'type'         => 'text',
